  ...
  return (
    <div className="app-layout">
      ...
      >
        ...
        <div className="shrink-0 flex items-center justify-between gap-2 px-5 pt-6 pb-4">
         ...
         * px-4 on the nav inset + px-3 on each item = 28px from sidebar
         * edge to item text. Hover pill insets nicely. */}
        <nav className="flex-1 flex flex-col min-h-0 overflow-y-auto px-4 pt-3">
          <SessionList />
          <ScheduleList />
          <CredentialList />
        </nav>
