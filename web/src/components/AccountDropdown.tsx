...
export function AccountDropdown({ onSignOut }: { onSignOut: () => void }) {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="top" align="start" sideOffset={8} className="w-[240px]">
        <div className="px-3 py-3">
          <div className="flex items-center gap-3">
            <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary-200 text-primary-700 text-sm font-medium">
              {initial}
            </span>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem
          className="btn-logout gap-3 px-3 py-2.5 rounded-lg"
          onSelect={onSignOut}
        >
