      ...
      return message.role === "user" ? (
        <div className="msg msg-user flex justify-end">
          <div className="max-w-[85%] space-y-1">
            ...
            <div className="msg-content inline-block rounded-lg bg-primary px-6 py-5 text-sm text-primary-foreground whitespace-pre-wrap break-words">
              {message.content}
            </div>
          </div>
        </div>
        ...
        <div className="msg msg-assistant space-y-1">
          ...
          <div className="msg-content markdown rounded-lg border border-border bg-card px-6 py-5 text-sm leading-7">
      ...
      return (
        <div className="msg msg-user flex justify-end">
          <div className="max-w-[85%] space-y-1">
            ...
            <div className="msg-content msg-question-answer inline-block rounded-lg bg-primary/80 px-6 py-5 text-sm text-primary-foreground italic whitespace-pre-wrap break-words">
              {message.content}
            </div>
          </div>
        </div>
    ...
    case "error":
      return (
        <div className="msg msg-error space-y-1">
          ...
          <div className="msg-content rounded-lg border border-destructive/40 bg-destructive/10 px-6 py-5 text-sm text-destructive whitespace-pre-wrap break-words">
            {message.content}
          </div>
        </div>
      );
