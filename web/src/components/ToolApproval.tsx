...
export function ToolApproval({ message, onApprove, onDeny }: Props) {
  ...
  return (
    <div className="msg msg-approval rounded-lg border-[0.7px] border-yellow-200 bg-yellow-50 overflow-hidden">
      <div className="approval-header flex items-center gap-2.5 px-6 py-5 text-sm">
      ...
      <pre className="approval-detail border-t border-yellow-200 bg-card/60 px-6 py-4 text-xs font-mono text-foreground overflow-x-auto whitespace-pre-wrap break-words max-h-60 overflow-y-auto">
