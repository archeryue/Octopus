...
export function ToolApproval({ message, onApprove, onDeny }: Props) {
  ...
  return (
    <div className="msg msg-approval rounded-lg border-[0.7px] border-yellow-200 bg-yellow-50 overflow-hidden">
      ...
      <pre className="approval-detail border-t border-yellow-200 bg-card/60 px-3 py-2 text-xs font-mono text-foreground overflow-x-auto whitespace-pre-wrap break-words max-h-60 overflow-y-auto">
