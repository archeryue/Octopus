...
1. **Backend unit tests**: `.venv/bin/pytest tests/ -v` (1040 tests; all of them
...
2. **Frontend unit tests**: `cd web && bun run test` (159 tests)
3. **TypeScript check**: `cd web && npx tsc --noEmit`
4. **E2E tests**: `cd web && bun run test:e2e` (72 tests, no skips, ~3 min, Playwright
