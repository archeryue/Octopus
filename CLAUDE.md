...
1. **Backend unit tests**: `.venv/bin/pytest tests/ -v` (959 tests; all of them
...
2. **Frontend unit tests**: `cd web && bun run test` (122 tests)
3. **TypeScript check**: `cd web && npx tsc --noEmit`
4. **E2E tests**: `cd web && bun run test:e2e` (69 tests, no skips, ~3 min, Playwright
