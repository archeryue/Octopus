...
1. **Backend unit tests**: `.venv/bin/pytest tests/ -v` (1181 tests; all of them
   ...
   the claude→codex case in `test_delegations_real.py` +
   `test_schedule_mcp_real.py` (two claude cases, one codex) need **both** —
